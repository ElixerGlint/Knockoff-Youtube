...
public class HappyDriver {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Color temp2 = JColorChooser.showDialog(null, "What color do you want the accent to be?", Color.green); //first thing

		NewYearPanel Everything = new NewYearPanel(bgColor,vidselection,temp2);
